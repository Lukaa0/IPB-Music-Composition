...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('-n_songs', default=1, type=int,
                            help='Number of files to generate')

    arg_parser.add_argument('-checkpoint_path', default="checkpoints_music/checkpoint1.h5", type=str,
    ...
    arg_parser.add_argument('-o', '--dst_dir', type=str, default='generated_midis',
                            help='Directory where the generated midi files will Multi_Head_Attention stored')
    ...
    arg_parser.add_argument('-v', '--visualize_attention', default="statistics", action='store_true',
